...
namespace Durak.Auth.Web.Endpoints.SecurityEndpoints
{
    /// <summary>
    ...
    public class AuthorizeEndpoints : AppDefinition
    {
            ...
            IOpenIddictAuthorizationManager authorizationManager)
        {
            ...
            switch (await applicationManager.GetConsentTypeAsync(application))
            {
                ...
                case OpenIddictConstants.ConsentTypes.External when authorizations.Any():
                case OpenIddictConstants.ConsentTypes.Explicit when authorizations.Any() && !iRequest.HasPrompt(OpenIddictConstants.Prompts.Consent):
                    ...
                    // principal.SetScopes(iRequest.GetScopes());
                    ...
                    foreach (var claim in principal.Claims)
                    {
                        claim.SetDestinations(claim.Type switch
                        {
                            ...
                            OpenIddictConstants.Claims.Name when principal.HasScope(OpenIddictConstants.Scopes.Profile) => new[]
                            {
